...
if($utilisateur!=null){ // Si quelqu'un de connecté
  ...
  // Recupération de l'ensemble des réservation rejoignables par l'utilisateur actuel
  $reservations = $dao->getReservationsRejoignables($utilisateur->email);

  // Assignation des reservations récuperées
  ...
  $view->display("rejoindre.view.php");
