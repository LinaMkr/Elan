...
$lieux = $dao->getLieux();
if (isset($_POST['lieu'])) {
  $reservations = $dao->getEvenements($_POST['lieu']);
  $nomLieuAffiche =  $_POST['lieu'];
} else {
  $reservations = $dao->getEvenements($lieux[0]->nomLocal);
...
foreach ($reservations as $r) {
  // Mise en format "2020-01-01-16-00-00" de la date pour faciliter l'utilisation dans l'agenda
...
$view->display("agendaEvenement.view.php");
