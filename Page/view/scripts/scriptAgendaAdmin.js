...
function ajouterReservation(reservation) {
    ...
    do {
        ...
        // Création du td (case) qui affiche la reservation et définition de ses attributs
        ...
        tableTd.innerHTML = "<strong> Nom réservation : </strong>" +reservation.get("nomReservation").charAt(0).toUpperCase() + reservation.get("nomReservation").slice(1);
        tableTd.innerHTML += "<br><strong> Type réservation : </strong>" + reservation.get("typeReservation");
        tableTd.innerHTML += "<br><strong> Mél. : </strong>" + reservation.get("email");
        tableTd.innerHTML += "<br><strong> Nombre de Personne : </strong>" + reservation.get("nbPersonne");
        tableTd.innerHTML += "<br><strong> Place restante : </strong>" + reservation.get("placeRestante");
        tableTd.innerHTML += "<br><strong> Durée : </strong> " + meetingDuration + "h";
        // meetindDuration * 2 car la durée est en heure et l'agenda comprends des demi heures 
